  ...
  try {
    ...
    const data = await product.updateOne(
      { _id: req.body._id },
      {
        ...
        rating: req.body.rating ? req.body.rating : productDetails.rating,
        seller: req.body.seller ? req.body.seller : productDetails.seller,
        ...
        image: req.body.imageName ? req.body.imageName : productDetails.image,
      }
    );
